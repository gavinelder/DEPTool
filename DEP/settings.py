...
RUN_AS_MUNKIADMIN = os.path.join(BASE_DIR, 'run_as_munkiadmin.sh')

if not os.path.exists(RUN_AS_MUNKIADMIN):
    sys.exit("{} doesn't exist.".format(RUN_AS_MUNKIADMIN))
...
SYNC_DEP_DEVICES = os.path.join(BASE_DIR, 'sync_dep_devices.sh')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, "configs/database.sqllite3"),
    }
}
